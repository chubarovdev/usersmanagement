...
@section('content')
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="{{route('storeNewUser')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-xl-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="vk_link" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="telegram_link" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input name="instagram_link" type="text" class="form-control border-left-0 bg-transparent pl-0">
                                        </div>
                                    </div>
